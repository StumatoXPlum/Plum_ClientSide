...
import 'package:task1/pie_chart/view_model/pie_chart_vm.dart';
...
class PieChartScreen extends StatelessWidget {
  ...
  final pieModelData = DummyPieData.getDummyPieData();
  late final foreGroundWidgetData = ForegroundWidgetVm(
    header: pieModelData.title,
    amount: pieModelData.amount,
    buttonText: pieModelData.cta.label,
  );
...
class PieChartWidget extends StatelessWidget {
  ...
  final PieModel dummyData = DummyPieData.getDummyPieData();
  late final List<HomeVisualSectionItemVm> pieChartData =
      HomeVisualSectionItemVm.getPieChartData(dummyData);
